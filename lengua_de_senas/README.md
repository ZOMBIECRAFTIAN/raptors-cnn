...
Este módulo contiene el catálogo de señas en **International Sign (IS)** para las **53 especies de rapaces diurnas de México** objetivo del proyecto. Es el componente social del sistema y cumple con los principios del Diseño Universal para el Aprendizaje (CAST, 2018).
